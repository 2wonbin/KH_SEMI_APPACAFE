...
public class CommonUtil {
	...
	public static String getPageBarSell(int totalContents, int cpage, int numPerPage, String url) {
		String pageBar = "";
	...
	public static String getPageBar(int totalContents, int cpage, int numPerPage, String url, String boardType) {
		String pageBar = "";
		...
		if(boardType == null) {
			...
			url = url + (url.indexOf("?") > -1 ? "&" : "?") + "boardType="+ boardType + "&cpage=";
